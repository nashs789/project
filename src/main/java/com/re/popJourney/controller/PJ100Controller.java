...
public class PJ100Controller {
    ...
    // 메인화면 - 공지사항
    // notices
    @PostMapping(value="/selectPJ100NoticeList", produces="application/json;charset=UTF-8")
    ...
    // 메인화면 - 지역별 랭킹
    // regionBoards
    @PostMapping(value="/selectPJ100regionBoardList", produces="application/json;charset=UTF-8")
