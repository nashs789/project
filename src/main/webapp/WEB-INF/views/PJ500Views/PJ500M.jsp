...
<title>마이페이지</title>
	...
	<link href="static/css/PJ500Css/PJ500C.css" rel="stylesheet" type="text/css">
	<script type="text/javascript" src="static/script/jquery/jquery-1.12.4.min.js"/></script>
	<script type="text/javascript" src="static/script/jquery/jquery.form.js"/></script>
	<script type="text/javascript" src="static/js/common.js"></script>
	<script type="text/javascript" src="static/js/PJ500Js/PJ500S.js"></script>
		...
		success:function(result) {
			...
			if(result.msg == "success") {
				...
				if("${sPHOTO_PATH}" != "") {
					...
					$("#profilePhoto").attr("src", path);
					path = "static/images/profile3.png";
					html += "<img alt=\"profile\" src=\"" + path + "\"class=\"profile_img\">";
				}
