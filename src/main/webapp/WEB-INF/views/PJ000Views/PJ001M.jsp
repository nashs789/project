...
<html>
	<head>
		...
		<link href="static/css/PJ000Css/PJ001C.css" rel="stylesheet" type="text/css">
		...
		<script type="text/javascript" src="static/js/PJ000Js/PJ001S.js"></script>
				...
				<div class="mem_admin_area">
					...
					<form action="#" id="actionForm" method="post">
						<div class="sub_search">
							...
							<input class="post_delete_btn" type="button" id="postDeleteBtn" value="게시글삭제" />
						</div>
						<div id="list_wrap">
							<table>
								<colgroup>
